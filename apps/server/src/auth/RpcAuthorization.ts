...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.workflowRepositories]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowRoots]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowWatch]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowRefresh]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.workflowLocate]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowRecovery]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowRecover]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowDirectorStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowDirectorStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowActiveWork]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowDirectorHandoffReconcile]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowDirectorReassessmentRetry]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowDirectorResume]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowDirectorAdmit]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowAdoptionPreview]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowAdoptionHistory]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowAdoptionRecover]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowAdoptionApply]: AuthOrchestrationOperateScope,
  [WS_METHODS.workflowAdoptionUndo]: AuthOrchestrationOperateScope,
